<template><div><p>MetaMask is one of the leading cryptocurrency wallets on the market, with over one million monthly active users across all supported devices and browsers. It is free to use, allowing you to connect and interface with any Web3 websites and applications. If you want to use decentralized exchanges, you will want to familiarize yourself with a wallet like MetaMask. In this guide, we will walk you through the process of how to install and set up MetaMask on PC for Chrome, Firefox, and Microsoft Edge, as well as mobile for iOS and Android devices.</p>
<p>Please note that these instructions may vary slightly depending on which browser you use. Regardless of your browser of choice, you can still follow these steps to learn how to install and set up MetaMask on PC and Mobile.</p>
<!-- more -->
<h2 id="here-is-how-to-set-up-and-install-metamask-on-a-desktop-browser" tabindex="-1"><a class="header-anchor" href="#here-is-how-to-set-up-and-install-metamask-on-a-desktop-browser" aria-hidden="true">#</a> Here is how to set up and install MetaMask on a desktop browser</h2>
...
<h2 id="here-is-how-to-set-up-and-install-metamask-on-mobile-devices" tabindex="-1"><a class="header-anchor" href="#here-is-how-to-set-up-and-install-metamask-on-mobile-devices" aria-hidden="true">#</a> Here is how to set up and install MetaMask on mobile devices</h2>
...
<h2 id="download-and-install-metamask" tabindex="-1"><a class="header-anchor" href="#download-and-install-metamask" aria-hidden="true">#</a> Download and install MetaMask</h2>
...
<h3 id="getting-started" tabindex="-1"><a class="header-anchor" href="#getting-started" aria-hidden="true">#</a> Getting Started</h3>
...
<h3 id="create-your-wallet" tabindex="-1"><a class="header-anchor" href="#create-your-wallet" aria-hidden="true">#</a> Create Your Wallet</h3>
...
<h4 id="secret-backup-phrase" tabindex="-1"><a class="header-anchor" href="#secret-backup-phrase" aria-hidden="true">#</a> Secret Backup Phrase</h4>
<div v-pre>
...
<h4 id="how-to-find-your-ethereum-address-in-metamask" tabindex="-1"><a class="header-anchor" href="#how-to-find-your-ethereum-address-in-metamask" aria-hidden="true">#</a> How to find your Ethereum address in MetaMask</h4>
...
<h4 id="how-to-sync-metamask-across-devices" tabindex="-1"><a class="header-anchor" href="#how-to-sync-metamask-across-devices" aria-hidden="true">#</a> How to Sync Metamask Across Devices</h4>
...
<ul>
<li>
<p><RouterLink to="/monumental/introduction.html">Introduction</RouterLink></p>
</li>
<li>
<p><RouterLink to="/monumental/markdown.html">Markdown Enhance</RouterLink></p>
</li>
<li>
<p><RouterLink to="/monumental/page.html">Page Config</RouterLink></p>
</li>
<li>
<p><RouterLink to="/monumental/disable.html">Function Disable</RouterLink></p>
</li>
</ul>
<ul>
